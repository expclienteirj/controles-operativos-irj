...
--
-- Generado desde app/backend/schema.sql. No editar a mano: la única
-- fuente sigue siendo ese archivo, y este se regenera desde él.
--
-- Pegar entero en el SQL Editor de Supabase y ejecutar una vez.
-- Las sentencias están ordenadas por dependencias y todas son
-- IF NOT EXISTS / OR REPLACE, así que volver a correrlo no rompe nada.

-- Funciones que replican las de SQLite y que el esquema usa en los DEFAULT.
...
-- Tablas e índices, en orden de dependencias.
