...
INSERT INTO config (clave,valor,grupo,descripcion,editable) VALUES ('liquidacion_dia_inicio', '26', 'general', 'Día del mes en que arranca la preparación de la liquidación. Desde esa fecha el semáforo de la pantalla de inicio dice si el mes está listo para certificar; antes no opina, porque liquidar el día 8 no es una tarea pendiente. Editable: es una fecha de proceso, no una constante.', '1') ON CONFLICT DO NOTHING;
...
INSERT INTO config (clave,valor,grupo,descripcion,editable) VALUES ('penalizacion_nc_tope_activo', 'false', 'certificacion', '¿Rige un tope para el descuento por no conformidades? Viene DESACTIVADO: el tope no surge del pliego y, como cada desvío genera una NC, cualquier mes real lo alcanza — a partir de ahí la penalización deja de distinguir un mes de otro. Activarlo solo si se acuerda un tope con el contratista.', '1') ON CONFLICT DO NOTHING;
INSERT INTO config (clave,valor,grupo,descripcion,editable) VALUES ('penalizacion_nc_tope', '0.2', 'certificacion', '⚠ VALOR PROVISORIO, NO SURGE DEL PLIEGO — Tope del descuento acumulado por no conformidades. Solo se aplica si el tope está activado.', '1') ON CONFLICT DO NOTHING;
INSERT INTO config (clave,valor,grupo,descripcion,editable) VALUES ('penalizacion_nc_activa', 'false', 'certificacion', '¿Las no conformidades descuentan del importe a certificar? Viene DESACTIVADA y así debe quedar mientras no se negocie: el PET dice que la calidad se ajusta según las no conformidades pero NO fija ninguna fórmula, y descontar con un criterio propio es cobrarle al contratista sobre una regla que nadie acordó. Las NC se registran e informan igual.', '1') ON CONFLICT DO NOTHING;
